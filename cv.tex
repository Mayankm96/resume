...
\item Implemented the \textbf{object detection model `YOLOv2'} by Joseph Redmon \textit{et al.} using ROS and Caffe framework to classify objects as potential explosives in real time
\end{itemize}}
...
\textit{Course Project for Probabilistic Robotics (EE698G)}, Prof. Gaurav Pandey%
\begin{itemize}%
% \renewcommand\labelitemi{--}
...
\textit{Course Project for Robot Motion Planning (ME766A)}, Prof. Ashish Dutta
\begin{itemize}%
...
\textit{Course Project for Embedded and Cyber-Physical Systems (CS637A)}, Prof. Indranil Saha
\begin{itemize}%
...
\item Used gazebo to simulate swarm behavior in quadrotors using \texttt{hector-quad} packages
...
\textit{Course Project for Robust Control Systems (EE654A)}, Prof. Ramprasad Potluri
\begin{itemize}%
\item Proposed an alternate design to the original controller by P. Colmegna \textit{et al.}, \item Used \textbf{Robust Control Toolbox} and \textbf{Simulink}  to show that new controller ensured a better performance for the considered nominal model of adult patient
\end{itemize}
}
...
\textit{NYU-IIT Kanpur Research Track}, Prof. Farshad Khorrami (New York University)
\begin{itemize}%
\item Reviewed \textbf{Kalman Filter} and \textbf{Monte- Carlo methods} for back-end system in SLAM
\item Implemented \textbf{EKF SLAM} in virtual environment through \textbf{V-REP} and MATLAB
\end{itemize}
}
...
\textit{Course Project for course Manufacturing Processes-II (TA202A)}, Prof. Neeraj Sinha
\begin{itemize}%
\item Designed and manufactured a scaled-down model of \textbf{dental chair} with independent controls for various motion, using operations like welding, turning, milling, drilling and fitting
\end{itemize}
}
...
\textit{NPDE-TCA Winter Internship}, Dr. B.V. Rathish Kumar (IIT Kanpur)
\begin{itemize}%
\item Studied the Ritz-vibrational and Glarenkin's finite element analysis in 1- and 2- dimensions
\item Solved 2-D boundary valued problems on electrostatics and time harmonics on MATLAB
\end{itemize}
}
...
\cvitem{2017}{\textbf{WISE Scholarship} by DAAD (Awarded to 192 students in the country)}
\cvitem{2016}{\textbf{Academic Excellence Award}, IIT Kanpur (Awarded to 60 students out of 840)}
\cvitem{2016}{$\mathbf{2^{nd}}$ \textbf{place} in \textbf{Student Underwater Vehicle} (SAVe) competition by NIOT, Chennai}
\cvitem{2014}{\textbf{All India Rank 656} in JEE Advanced among 150,000 students}
\cvitem{2014}{\textbf{All India Rank 324} in JEE Mains among 1.2 million students}
\cvitem{2012}{\textbf{Kishore Vaigyanik Protsahan Yogna} (KVPY) Fellowship by Govt. of India }
\cvitem{2010}{\textbf{National Talent Search Scholarship} (NTSE)  by Govt. of India}

\section{Technical skills}
\cvitem{\textbf{Software:}}{Gazebo, UnrealEngine Editor (AirSim), V-REP, SolidWorks, Ansys, KiCAD, PSpice}
\cvitem{\textbf{Languages:}}{Python, C++, C, Shell(bash), MATLAB, HTML, CSS}
\cvitem{\textbf{Frameworks:}}{ROS, Caffe, TensorFlow, OpenCV, PCL}
% \cvitem{\textbf{Simulation:}}{Gazebo, UnrealEngine Editor (AirSim), V-REP}
% \cvitem{\textbf{Platforms:}}{dsPIC, Arduino, Odroid, NVidia Jetson, TIVA-C Launchpad}
...
\item Overseeing various \textbf{operational and technical} aspects of the project
\item Managed funding of Rs.769,000 for the development of our first vehicle \textit{Varun}
\end{itemize}}
